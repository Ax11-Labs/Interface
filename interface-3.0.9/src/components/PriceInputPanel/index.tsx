...
const Container = styled.div<{ hideInput: boolean }>`
  ...
  background-color: ${({ theme }) => rgba(theme.bg2, 0.6)};
  :focus,
  :hover {
...
export default function PriceInputPanel({
  ...
  return (
    <InputPanel id={'price-input-panel'} >
        ...
        {/* <CurrencySelect
          ...
          {/* {!hideInput && (  
            <> */}
              ...
              <SetPrice>
                Set Price
                <QuestionHelper text={"We support token price with the maximum precision of 38 decimals."} />
              </SetPrice>
